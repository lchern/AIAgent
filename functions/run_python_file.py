...
schema_run_python_file = {
    ...
    "function": {
        ...
        "description": "Runs the python file relative to the working directory. Might process optional arguments.",
        "parameters": {
            "type": "object",
            "required": "file_path",
            "properties": {
                ...
                "args": {
                    "type": "array",
                    "items": "string",
                    "description": "Possible arguments for the function. Default is None",
                }
            },
        },
    },
